...
class TestExtSemester:


    @pytest.fixture()
    def ext(self, models, mock_corpus):
    ...
    def test_fall_semester(self, ext):
    ...
    def test_spring_semester(self, ext):
    ...
    def test_ignore_future_years(self, ext):
        pass


    def test_ignore_old_years(self, ext):
        pass
